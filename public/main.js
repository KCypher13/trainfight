...
function openMenu(){
    ...
    var _html = '<div class="customMenu"><div class="triangle';
    if($(this).parent().position().top>400){
        _html += ' reverse';
    }
    _html+= '"></div><div class="menuContent';
    if($(this).parent().position().top>400){
        _html += ' reverse';
    }
    _html += '"><p class="stationName">'+_stationName+'</p><p class="stationLine">'+_lineStation+'</p><ul>';
